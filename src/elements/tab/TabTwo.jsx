                ...
                <Tabs>
                  ...
                  <TabPanel>
                    <div className="single-tab-content">
                      <ul>
                        <li>
                          <a href="/service">
                            Web Development <span> - MERN Stack</span>
                          </a>
                        ...
                        <li>
                          <a href="/service">
                            ...
                            <span> - Native IOS/Android | Cross-Platform</span>
                          </a>
                  ...
                  <TabPanel>
                    <div className="single-tab-content">
                      <ul>
                        <li>
                          <a href="https://congress.iads-web.com/">
                            Website Developer & Design Consultant
                            <span>
                              {" "}
                        ...
                        <li>
                          <a href="/service">
                            Part-time MERN Full Stack Instructor
                            <span> - GOMYCODE, Egypt</span>
                          </a>
                          February 2021 - January 2022
                        </li>
                        <li>
                          <a href="/service">
                            Student, Data Analytics<span> - Google </span>
                          </a>
                          November 2021 - Current
                        </li>
                        <li>
                          <a href="/service">
                            Student Member<span> - ACM & IEEECS </span>
                          </a>
                          August 2018 - Current
                        </li>
                        <li>
                          <a href="/service">
                            ...
                            <span>
                              {" "}
                              - GITEX Highflyer YouthX, Ai Everything, UAE{" "}
                            </span>
                          </a>
                          October 2021
                        </li>
                        ...
                        <li>
                          <a href="/service">
                            IOS Application development bootcamp
                            <span> - London App Brewery </span>
                          </a>
                  ...
                  <TabPanel>
                    <div className="single-tab-content">
                      <ul>
                        ...
                        <li>
                          <a href="/service">
                            BSc In CSCE (Incomplete, Transferred)
                            <span>
                              {" "}
